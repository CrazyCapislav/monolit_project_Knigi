...
import dev.petr.auth.application.dto.CreateUserRequest;
import dev.petr.auth.application.dto.RegisterRequest;
import dev.petr.auth.application.dto.UserResponse;
import dev.petr.auth.domain.model.Role;
import dev.petr.auth.domain.model.User;
import dev.petr.auth.infrastructure.persistence.repository.UserRepository;
