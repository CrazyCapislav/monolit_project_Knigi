...
echo "Topic details:"
kafka-topics --describe --topic exchange-events --bootstrap-server kafka-1:29092
kafka-topics --describe --topic notification-events --bootstrap-server kafka-1:29092
kafka-topics --describe --topic book-events --bootstrap-server kafka-1:29092